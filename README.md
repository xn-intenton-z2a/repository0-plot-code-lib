...
4. Gracefully ignore empty tokens resulting from optional trailing or extra commas, enhancing usability without compromising strict validation of numeric inputs.
